...
function verifyUser(latestEnrollmentIdentifier, userImage) {
    // let userImage = userImageList.get('AAA1234');
    var url = 'https://api.facetec.com/api/v3.1/biometrics/match-3d-2d-face-portrait';
    var data = {
    ...
    fetch(url, {
        ...
        headers: {
            ...
            'X-Device-Key': 'dWlxZqtVFPFwqGScBhDSIGticRJEk5tD'
        },
...
var EnrollmentProcessor = /** @class */ (function () {
    function EnrollmentProcessor(sessionToken, sampleAppControllerReference, userImage) {
        var _this = this;
                ...
                if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                    try {
                        ...
                        if (responseJSON.wasProcessed) {
                            ...
                            console.log("Done!");
                            console.log(_this.sampleAppControllerReference.getLatestEnrollmentIdentifier());
                            verifyUser(_this.sampleAppControllerReference.getLatestEnrollmentIdentifier(), userImage);
                        }
                        else {
